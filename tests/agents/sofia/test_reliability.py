...
class TestSofiaAgentReliability:
                                    ...
                                    with patch('src.agents.simple.sofia.agent.extract_tool_calls', return_value=[]):
                                        with patch('src.agents.simple.sofia.agent.extract_tool_outputs', return_value=[]):
                                            with patch('src.agents.simple.sofia.agent.get_llm_semaphore') as mock_semaphore:
                                                ...
                                                with patch('src.agents.simple.sofia.agent.settings') as mock_settings:
                                    ...
                                    with patch('src.agents.simple.sofia.agent.extract_tool_calls', return_value=[]):
                                        with patch('src.agents.simple.sofia.agent.extract_tool_outputs', return_value=[]):
                                            with patch('src.agents.simple.sofia.agent.get_llm_semaphore') as mock_semaphore:
                                                ...
                                                with patch('src.agents.simple.sofia.agent.logger') as mock_logger:
                                                    with patch('asyncio.sleep', new_callable=AsyncMock):
                                                        result = await sofia_agent.run("Test input")
    ...
    def test_reliability_imports_exist(self, sofia_agent):
        ...
        import src.agents.simple.sofia.agent as sofia_module
