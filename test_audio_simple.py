#!/usr/bin/env python3
"""Test audio functionality for simple agent."""
...
def send_message_with_audio(message: str, session_name: str, audio_path: str, session_id: str = None):
    """Send a message with audio to the API."""
...
def main():
    """Run audio test for simple agent."""
    print(f"🚀 AUDIO TEST - {AGENT_NAME.upper()}")
    print("="*60)
    ...
    session_name = f"test-{AGENT_NAME}-audio"
    
    # Send audio for analysis
    print(f"\n1. Sending audio to {AGENT_NAME} agent...")
    result = send_message_with_audio(
