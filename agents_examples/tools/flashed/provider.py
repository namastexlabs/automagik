...
class FlashedProvider():
    ...
    def __init__(self):
        ...
        # Try to get from extensible API keys first, fallback to environment variables
        self.base_url = settings.get_external_url('FLASHED_API_URL') or os.environ.get('FLASHED_API_URL')
        self.auth_token = settings.get_external_api_key('FLASHED_API_KEY') or os.environ.get('FLASHED_API_KEY')
        ...
        self._mock_conversation_codes = {
            "ProMock123": "123e4567-e89b-12d3-a456-426614174000",  # Pro user code
