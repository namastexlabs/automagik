#!/usr/bin/env python3
"""
Fixed version of the Claude Code API test script with correct authentication.
...
Usage:
    uv run python scripts/test_claude_code_api_fixed.py
"""
...
if __name__ == "__main__":
    ...
    import requests
    try:
        # Note: Health check doesn't require auth
