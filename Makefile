...
help: ## 🪄 Show this help message
	...
	@echo -e "  $(FONT_PURPLE)install-pip$(FONT_RESET)     Install package via pip (editable mode)"
	@echo ""
	...
	@echo -e "  $(FONT_PURPLE)restart-service$(FONT_RESET) Restart local PM2 service"
	@echo -e "  $(FONT_PURPLE)uninstall-service$(FONT_RESET) Uninstall local PM2 service"
	@echo -e "  $(FONT_PURPLE)status$(FONT_RESET)          Show service status"
	@echo ""
	@echo -e "$(FONT_CYAN)🔧 Local PM2 Management:$(FONT_RESET)"
	@echo -e "  $(FONT_PURPLE)start-local$(FONT_RESET)     Start service using local PM2 ecosystem"
	@echo -e "  $(FONT_PURPLE)stop-local$(FONT_RESET)      Stop service using local PM2 ecosystem"
	@echo -e "  $(FONT_PURPLE)restart-local$(FONT_RESET)   Restart service using local PM2 ecosystem"
	@echo ""
	...
	@echo -e "  $(FONT_PURPLE)build-pip$(FONT_RESET)       Build pip package for distribution"
	@echo -e "  $(FONT_PURPLE)clean-build$(FONT_RESET)     Clean build artifacts"
	...
	@echo -e "  $(FONT_PURPLE)publish$(FONT_RESET)         Create GitHub release (triggers PyPI publish)"
	@echo -e "  $(FONT_PURPLE)publish-test$(FONT_RESET)    Upload to TestPyPI"
	@echo -e "  $(FONT_PURPLE)publish-pip$(FONT_RESET)     Publish package to PyPI (manual)"
	@echo -e "  $(FONT_PURPLE)publish-github$(FONT_RESET)  Create GitHub release (same as publish)"
	@echo -e "  $(FONT_PURPLE)publish-dev$(FONT_RESET)     Build and publish dev version to PyPI"
	@echo ""
	@echo -e "$(FONT_CYAN)📈 Version Management:$(FONT_RESET)"
	@echo -e "  $(FONT_PURPLE)bump-patch$(FONT_RESET)      Bump patch version (0.1.0 -> 0.1.1) - no commit"
	@echo -e "  $(FONT_PURPLE)bump-minor$(FONT_RESET)      Bump minor version (0.1.0 -> 0.2.0) - no commit"
	@echo -e "  $(FONT_PURPLE)bump-major$(FONT_RESET)      Bump major version (0.1.0 -> 1.0.0) - no commit"
	@echo -e "  $(FONT_PURPLE)bump-dev$(FONT_RESET)        Create dev version (0.1.2 -> 0.1.2pre1)"
	@echo -e "  $(FONT_PURPLE)finalize-version$(FONT_RESET) Remove 'pre' from version (0.1.2pre3 -> 0.1.2)"
	@echo ""
	@echo -e "$(FONT_CYAN)🎨 Utilities:$(FONT_RESET)"
	@echo -e "  $(FONT_PURPLE)print-test$(FONT_RESET)      Test color system"
	@echo ""
...
bump-patch: ## 📈 Bump patch version (0.1.0 -> 0.1.1)
	...
	echo -e "$(FONT_CYAN)💡 Ready for: make publish (will commit and publish)$(FONT_RESET)"
