...
agent-memory_search_memory --query "API endpoint patterns authentication"

# After successful implementation
agent-memory_add_memory --name "API Pattern Discovery" --episode_body "Successful custom endpoint pattern: Always use Depends(verify_api_key), return Pydantic models, validate input with Field constraints" --source "text"
```
