...
function ProjectsPage() {
    ...
    const loadProjects = async ()=>{
        ...
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiService"].getProjects(user.id);
            setProjects(data);
        } catch (error) {
    ...
    const handleCreateProject = async (e)=>{
        ...
        if (!user?.id) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiService"].createProject(user.id, {
                name: formData.name,
    ...
    const handleDeleteProject = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiService"].deleteProject(user.id, id);
            loadProjects();
        } catch (error) {
            console.error('Error deleting project:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$5_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Error deleting project');
        }
    };
    if (loading) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c29cb6f3._.js.map