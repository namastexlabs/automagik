#!/usr/bin/env python3
"""Test multimodal functionality for flashinho agent."""
...
def main():
    """Run multimodal test for flashinho agent."""
    ...
    result = send_message_with_image(
        "Olha essa questão que não consigo resolver",
        session_name
    )
